...
public class AppointmentEditController {
    ...
    private Appointment appointmentOld;
    public Appointment getAppointmentOld() { return appointmentOld; }
...
//                -> appointment.setStartLocalDateTime(newValue));
        ...
        appointmentGroupGridPane.setupData(appointment, layoutHelp);
        ...
        groupTextField.textProperty().addListener((observable, oldSelection, newSelection) ->  {
            ...
            appointmentGroupGridPane.updateToolTip(i);
            groupNameChanged.set(true);
        });
            }
